...
typedef struct  
{
	...
	float Velocity_KPL; //Speed control PID parameters //速度控制PID参数
	float Velocity_KPR; //Speed control PID parameters //速度控制PID参数
	float Velocity_KIL; //Speed control PID parameters //速度控制PID参数
	float Velocity_KIR; //Speed control PID parameters //速度控制PID参数
}Motor_parameter;
...
extern float Velocity_KPL, Velocity_KPR, Velocity_KIL, Velocity_KIR;
